<template>
  <section class="mt-5">
    ...
    <div
      class="mt-5 flex w-full items-start gap-6 overflow-x-auto rounded-lg border bg-card px-5 py-5 scrollbar-thin scrollbar-thumb-input scrollbar-thumb-rounded-md"
    >
